...
from voltha.extensions.mz_kpi_tests.adapter_pm_metrics_alt import AdapterPmMetricsAlt


class OltPmMetricsAlt(AdapterPmMetricsAlt):
    """
    ...
    def __init__(self, adapter_agent, device_id, grouped=False, freq_override=False,
        ...
        """
        super(OltPmMetricsAlt, self).__init__(device_id, adapter_agent,
                                           grouped=grouped, freq_override=freq_override,
                                           **kwargs)

        # PM Config Types are COUNTER, GUAGE, and STATE     # GUAGE is misspelled device.proto
        self.nni_pm_names = {
    ...
    def update_orig(self, pm_config):
        try:
